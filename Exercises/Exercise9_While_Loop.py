...
'''
while = if + for
break = # על מנת לצאת מהלולאה
continue = # לא ממשיך וחוזר לתחילת הלולאה
'''
while (True):
    name=input("Enter a name to enter the Menu: ")
    if (name == "hen"):
        print("\nHello Hen")
        break
    elif (name == "idan"):
        ...
        print("You don't have access to menu.")


print("You have access to menu.")
